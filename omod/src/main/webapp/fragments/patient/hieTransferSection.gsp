...
<script type="text/javascript">
    (function(jq) {
        var mohLogoDataUri = "${ui.resourceLink('rwandaemr', 'images/moh-logo.png')}";
        ...
        function buildTransferClinicianHtml(item) {
            ...
            return `
                <style>
                    ...
                    .tf-moh-logo { height: 120px; }
                </style>
                <div class="tf-sheet">
                    <div class="tf-head">
                        <div class="tf-left">
                            <div class="tf-row"><strong>REPUBLIC OF RWANDA</strong></div>
                            <div class="tf-row"><img class="tf-moh-logo" src="\${mohLogoDataUri}" alt="Ministry of Health" /></div>
